...
@Entry(
    "forward_audience",
    "Filters players pressing forward (W key).",
    Colors.GREEN,
    icon = "mi:arrow-up"
)
class ForwardAudience(
    override val id: String = "",
    override val name: String = "Forward Audience",
    ...
    override suspend fun display(): AudienceFilter = object : AudienceFilter(ref()), TickableDisplay {
        override fun filter(player: Player): Boolean = player.currentInput.isForward
